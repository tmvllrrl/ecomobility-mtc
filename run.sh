...
# 100% RV pen rate
# python dqn_run.py --rv-rate 1.0 --stop-iters 1000 --framework torch --num-cpu 12 --render
...
# # 50% RV pen rate
python dqn_run.py --rv-rate 0.5 --stop-iters 1000 --framework torch --num-cpu 16 --render 
