...
input_file_path1 = f"eval_results/onlyHVs_TL/{junc_id}_accel_profiles.csv"
input_file_path2 = f"eval_results/results_RV1.0/{junc_id}_accel_profiles.csv"
input_file_path3 = f"eval_results/results_RV0.2/{junc_id}_accel_profiles.csv"
input_file_path4 = f"eval_results/results_RV0.4/{junc_id}_accel_profiles.csv"
input_file_path5 = f"eval_results/results_RV0.6/{junc_id}_accel_profiles.csv"
input_file_path6 = f"eval_results/results_RV0.8/{junc_id}_accel_profiles.csv"
input_file_path7 = f"eval_results/results_RV0.1/{junc_id}_accel_profiles.csv"
...
ax.plot(x, y3, label="20% RVs", color="dodgerblue", linewidth=2)
...
# ax.plot(x, y6, label="80% RVs", color="teal", linewidth=2)
...
fs = 24
ax.set_title("Acceleration Profile", fontsize=fs)
...
plt.savefig(f"{junc_id}_accel_profile_20.png", bbox_inches="tight")
