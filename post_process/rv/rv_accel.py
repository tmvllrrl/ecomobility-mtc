...
def process_accel(args):
    ...
    rv_rate = str(args.rv_rate)

    input_file_path = f"../../eval_results/results_RV{rv_rate}/eval_trajectory.json"
    output_file_path = f"../../eval_results/results_RV{rv_rate}/{junc_id}_accel_profiles.csv"
