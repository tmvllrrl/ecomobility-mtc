...
output_file_path = 'eval_results/results_RV1.0/int_fuel_results.csv'

patterns = [r'OVERALL AVG FUEL CONSUMPTION AT JUNCTION 229: (\d+\.\d+)', r'OVERALL AVG FUEL CONSUMPTION AT JUNCTION 499: (\d+\.\d+)', r'OVERALL AVG FUEL CONSUMPTION AT JUNCTION 332: (\d+\.\d+)', r'OVERALL AVG FUEL CONSUMPTION AT JUNCTION 334: (\d+\.\d+)']
