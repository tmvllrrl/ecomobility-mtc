...
input_file_path = 'eval_results/results_RV0.1/all_results.txt'
output_file_path = 'eval_results/results_RV0.1/int_co2_results.csv'

patterns = [r'OVERALL AVG CO2 EMISSIONS AT JUNCTION 229: (\d+\.\d+)', r'OVERALL AVG CO2 EMISSIONS AT JUNCTION 499: (\d+\.\d+)', r'OVERALL AVG CO2 EMISSIONS AT JUNCTION 332: (\d+\.\d+)', r'OVERALL AVG CO2 EMISSIONS AT JUNCTION 334: (\d+\.\d+)']
