...
output_file_path = 'eval_results/results_RV1.0/int_hc_results.csv'

patterns = [r'OVERALL AVG HC EMISSIONS AT JUNCTION 229: (\d+\.\d+)', r'OVERALL AVG HC EMISSIONS AT JUNCTION 499: (\d+\.\d+)', r'OVERALL AVG HC EMISSIONS AT JUNCTION 332: (\d+\.\d+)', r'OVERALL AVG HC EMISSIONS AT JUNCTION 334: (\d+\.\d+)']
