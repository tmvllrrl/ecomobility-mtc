...
class NetMap(object):
    ...
    def query_edge_direction(self, edge_id, lane_id):
    ...
    def query_inner_edge_direction(self, edge_id, lane_id):
    ...
    def get_veh_moving_direction(self, veh):
        if veh.road_id[0] != ':':
            dir, label = self.query_edge_direction(veh.road_id, veh.lane_index)
            ...
            dir, label = self.query_inner_edge_direction(veh.road_id, veh.lane_index)
        if label:
