...
class SUMO(object):
    ...
    def setup_sub(self):
        ...
        self.subscribes.veh = SubscribeDef(tc.vehicle, [
            ...
            V.speed, V.position, V.angle, V.acceleration,
    ...
    def get_veh_fuel_consumption(self, veh):
        return self.tc.vehicle.getFuelConsumption(veh.id)
    
    def get_veh_co2_emission(self, veh):
        return self.tc.vehicle.getCO2Emission(veh.id)
    
    def get_veh_co_emission(self, veh):
        return self.tc.vehicle.getCOEmission(veh.id)
    
    def get_veh_hc_emission(self, veh):
        return self.tc.vehicle.getHCEmission(veh.id)
